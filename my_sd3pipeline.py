...
class my_StableDiffusion3Pipeline(StableDiffusion3Pipeline):
    @torch.no_grad()
    def __call__(self,
    ...
    output_dir: Optional[str] = None,):
        # Extract original input prompts from args and kwargs
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # Load transformer weights from the specified checkpoint directory
                checkpoint_dir = f"{output_dir}/checkpoint-{t:.4f}"
                print(f"Loading LoRA weights from {checkpoint_dir} with lora_scale {lora_scale}")
                self.load_lora_weights(checkpoint_dir, lora_scale=5.7)
