...
class compute_metrics():
    def __init__(self, img_path):
        ...
        self.ref_images = []
        for img_name in os.listdir("/home/u5649209/workspace/Diffusion_One/slurm/dog"):
            img_path = os.path.join("/home/u5649209/workspace/Diffusion_One/slurm/dog", img_name)
        ...
        self.ref_images = self.ref_images[:24]
    ...
    def compute_DINO(self):
        pass
cm_matrics = compute_metrics(img_path="/home/u5649209/workspace/Diffusion_One/evaluation/loraone/gamma100")
