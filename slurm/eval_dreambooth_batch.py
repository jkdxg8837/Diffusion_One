...
checkpoint_name_list = [i for i in range(0, 100, 10)]
for checkpoint_name in checkpoint_name_list:
    os.environ["OUTPUT_DIR"] = "/dcs/pg24/u5649209/data/workspace/diffusers/slurm/trained-sd3-lora-one_0.5/checkpoint-" + str(checkpoint_name)
    if os.path.exists(os.environ.get("OUTPUT_DIR") + "/output")
        continue;
    # 构造命令
    cmd = [
