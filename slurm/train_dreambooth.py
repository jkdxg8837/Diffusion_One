...
os.environ["OUTPUT_DIR"] = "trained-sd3-lora-dog-lichuan-r32-singlecard-wonumel-reinit80"
...
stable_gamma_list = [25, 36, 49, 53, 58, 64, 81, 100, 121, 144]
# 构造命令
...
for stable_gamma in stable_gamma_list:
    ...
    subprocess.run(eval_cmd)
    eval_cmd[eval_cmd.index("--output_dir") + 1] = cmd[8] + "/checkpoint-25"
    subprocess.run(eval_cmd)
