...
# 构造命令``
# Example conversions for the command:
# Original: python --img_path "./" "../eval_from_dir.py"
lora_scale = 5.7
# As a list for subprocess.run:
clip_score_cmd = [
    "python",
    "../eval_from_dir.py",
    "--img_path", "./"
...
for stable_gamma in stable_gamma_list:
    ...
    clip_score_cmd[clip_score_cmd.index("--img_path") + 1] = cmd[8] + f"/checkpoint-0/output_scale{lora_scale}"
