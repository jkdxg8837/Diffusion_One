...
from flow_matching_utils import MLP, train_moon_gen, evaluate_result
...
for i in range(rest_iterations):
    ...
    data_mode = "new"
    x_1, y = train_moon_gen(batch_size=batch_size, device=device, is_pretrain=False, mode = data_mode) # sample data
